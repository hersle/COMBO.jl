...
\begin{subequations}
\begin{align}
	{\Theta_0}^\prime   &= -\frac{ck}{\aH} \Theta_1 - \Phi^\prime , \\
	{\Theta_1}^\prime   &=  \frac{ck}{3\aH} \bigg[ \Theta_0 - 2 \Theta_2 + \Psi \bigg] + \tau^\prime \bigg[ \Theta_1 + \frac{v_b}{3} \bigg] , \\
	{\Theta_l}^\prime   &= \frac{ck}{(2l+1)\aH} \bigg[ l \, \Theta_{l-1} - (l+1) \Theta_{l+1} \bigg] + \tau^\prime \bigg[ \Theta_l - \frac{\Pi}{10} \delta_{l,2} \bigg] , \\
	{\Theta_l}^\prime   &= \frac{ck}{\aH} \Theta_{l-1} - \frac{l+1}{\aH \eta} \Theta_l + \tau^\prime \Theta_l, \\
	{\Theta^P_0}^\prime &= -\frac{ck}{\aH} \Theta^P_1 + \tau^\prime \bigg[ \Theta^P_0 - \frac{\Pi}{2} \bigg], \\
	{\Theta^P_l}^\prime &= \frac{ck}{(2l+1)\aH} \bigg[ l \, \Theta^P_{l-1} - (l+1) \Theta^P_{l+1} \bigg] + \tau^\prime \bigg[ \Theta^P_l - \frac{\Pi}{10} \delta_{l,2} \bigg] , \\
	{\Theta^P_l}^\prime &= \frac{ck}{\aH} \Theta^P_{l-1} - \frac{l+1}{\aH \eta} \Theta^P_l + \tau^\prime \Theta^P_l, \\
	{\N_0}^\prime       &= -\frac{ck}{\aH} \N_1 - \Phi^\prime , \\
	{\N_1}^\prime       &=  \frac{ck}{3\aH} \bigg[ \N_0 - 2 \N_2 + \Psi \bigg] , \\
	{\N_l}^\prime       &= \frac{ck}{(2l+1)\aH} \bigg[ l \, \N_{l-1} - (l+1) \N_{l+1} \bigg] , \\
	{\N_l}^\prime       &= \frac{ck}{\aH} \N_{l-1} - \frac{l+1}{\aH \eta} \N_l , \\

...
\begin{figure}
\centering
\includegraphics[scale=0.7]{../plots/Thetal0_zoom.pdf}
\caption{Zoom-in on $\Theta_0$ in \cref{fig_perturb_all}, showing its most rapid oscillations at the latest times.}
\label{fig_perturb_zoom}
\end{figure}

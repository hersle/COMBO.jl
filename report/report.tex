...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{../plots/power_spectrum_matter_fine.pdf}
\caption{
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{../plots/power_spectrum_CMB_TT_fine.pdf} \\
\includegraphics[width=0.7\textwidth]{../plots/power_spectrum_CMB_EE_fine.pdf} \\
\includegraphics[width=0.7\textwidth]{../plots/power_spectrum_CMB_TE_fine.pdf}
\caption{
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{../plots/power_spectrum_CMB_TT_crude.pdf} \\
\includegraphics[width=0.7\textwidth]{../plots/power_spectrum_CMB_EE_crude.pdf} \\
\includegraphics[width=0.7\textwidth]{../plots/power_spectrum_CMB_TE_crude.pdf}
\caption{
	...
	and $\Delta k = 2 \pi / 5 c \eta_0$ (instead of $2 \pi / 10 c \eta_0$) in spherical harmonics projection.
...
\Cref{fig_power_spectrum_cmb_crude} shows the same power spectra as in \cref{fig_power_spectrum_cmb},

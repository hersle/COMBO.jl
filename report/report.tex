...
Visibility function
\TODO{fix wrong $\tau'$ in code}
\begin{equation}
	g(\eta) = -\tau(\eta) \, e^{-\tau(\eta)}
\end{equation}
...
\begin{figure}
	...
	\caption{\TODO{$\tau'(\eta(x))$} Evolution of the optical depth $\tau(x)$ through recombination and reionization history, with or without both Helium and reionization.}

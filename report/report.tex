...
\begin{equation}
	D_l = \frac{l (l+1)}{2 \pi} \left(\frac{T_{\gamma 0}}{\mu \textrm{K}}\right)^2 C_l.
\label{eq_Dl}
\end{equation}
...
\caption{CMB power spectra with the fiducial Planck cosmology parameters \eqref{eq_planck2018}}
